;; =============================================================================
;; Highlights for Siemens SCL (tree-sitter-structured-control-language)
;; =============================================================================
...
;; Block-level RETAIN / NON_RETAIN (outside VAR block)
(block_attr) @keyword.modifier

;; BEGIN section in DATA_BLOCK
["BEGIN" "begin" "Begin"] @keyword

;; db_identifier used as a type reference — matched via (db_identifier) @namespace above

;; Return type — elementary_type and identifier are captured by
;; (elementary_type) @type.builtin and (var_declaration type: ...) below
...
(region_name) @comment  ;; Visually treat as annotation/label
...
;; User-defined type reference — identifier inside any type node
...
;; Local variable sigil
(lvalue "#" @punctuation.special)

;; DB / quoted identifier: "DBName"
(db_identifier) @namespace

;; Identifiers in an lvalue chain — distinguish plain ident from db_ident
...
(typed_literal)   @number    ;; e.g. INT#42, BOOL#TRUE
(int_literal)     @number
